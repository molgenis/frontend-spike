<template>
  <div class="table-container">
    <b-table :items="tableResources" :fields="fields" :filter="filter" :empty-text="$t('table-no-results')"
      class="text-left"
      show-empty>
...
<script>
import {SELECT_ALL_RESOURCES, DESELECT_ALL_RESOURCES, DESELECT_RESOURCE, SELECT_RESOURCE} from '@/store/actions/navigator'
